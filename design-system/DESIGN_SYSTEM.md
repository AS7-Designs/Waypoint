...
> **Changelog**:
> - 2026-08 onboarding completion update: updated Dashboard Onboarding Completion component to match Attendance Rate reference layout with header icon square, left-aligned thick donut ring, and right-stacked stroke-bordered statistic cards.
