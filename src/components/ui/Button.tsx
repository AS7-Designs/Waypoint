...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    primary: 'bg-primary text-white !text-white hover:bg-primary-dark active:scale-[0.98]',
    secondary: 'bg-white text-text-primary border border-border hover:bg-surface-muted active:scale-[0.98]',
    ghost: 'bg-transparent text-text-secondary hover:text-text-primary hover:bg-status-neutralBg',
    destructive: 'bg-accent-rose text-white !text-white hover:bg-rose-600 active:scale-[0.98]',
  };
